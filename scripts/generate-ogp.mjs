...
// used as the default social-share image for pages without a specific game cover. Not part of
...
const BADGES = [
  { label: "ゲーム", value: counts.games, color: "#8fd66b" },
  { label: "会社", value: counts.companies, color: "#f68fbe" },
  { label: "ジャンル", value: counts.genres, color: "#8adcae" },
  { label: "アワード", value: counts.awards, color: "#eea87e" },
];
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .glow--1 { width: 520px; height: 520px; top: -180px; right: -140px; background: #6bc34a; }
  .glow--2 { width: 460px; height: 460px; bottom: -200px; left: -120px; background: #cba7f2; }
  .badge {
    position: relative;
    width: 108px;
    height: 108px;
...
<body>
  ...
  <div class="badge">ゲ</div>
  <h1>ゲームDB</h1>
  <p class="tagline">PS5/Switch/Switch2向けゲームを対応機種・開発元/発売元・受賞歴・ジャンルから探せるデータベース</p>
  <div class="stats">
    ${BADGES.map(
